<template>
  <div>
    <el-card>
      ...
      <el-table :data="dataList" border size="mini" stripe style="margin-top: 15px;">
        ...
        <el-table-column fixed="right" label="操作" width="60">
          <template slot-scope="scope">
            <el-button   style="padding: 2px 6px;"    type="primary"    size="mini"     @click="showAreasCateDialog(scope.row)" >查看</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!-- 新增产品弹框 +++编辑产品弹框 -->
    <el-dialog :title="dailogTitle" :visible.sync="centerDialogVisible" width="50%" center>
      <el-form :model="addRuleForm" :rules="addRules" ref="addRuleForm" label-width="100px" class="demo-ruleForm" size="mini">
        <el-form-item label="产品名称" prop="name">
          <el-input v-model="addRuleForm.name" clearable disabled></el-input>
        </el-form-item>
        <el-form-item label="产品英文名称" prop="ename">
          <el-input v-model="addRuleForm.ename" clearable disabled></el-input>
        </el-form-item>
        <el-form-item label="选品人" prop="selection_id">
          <el-select placeholder="请选择选品人" v-model="addRuleForm.selection_id" clearable disabled>
            <el-option v-for="person in selectionpersondata" :key="person.admin_id" :label="person.nickname" :value="person.admin_id"></el-option>
          </el-select>
        </el-form-item>
        <!-- 供应商信息  start--->
        <div v-for="(pro,p) in addRuleForm.supplier" :key="p" class="proinfoborder" style="margin-top:15px;" >
          <el-form-item label="采购网址">
            <el-input size="mini" v-model="pro.buynetinput" disabled></el-input>
          </el-form-item>
          <el-form-item label="公司名称">
            <el-input size="mini" v-model="pro.companynameinput" disabled></el-input>
          </el-form-item>
          <el-row>
            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
              <el-form-item label="联系人">
                <el-input size="mini" v-model="pro.contactsinput" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
              <el-form-item label="电话">
                <el-input size="mini" v-model="pro.phoneinput" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
        ...
        <el-row :gutter="20" style="margin-top:15px;">
          <el-col :xs="10" :sm="10" :md="10" :lg="10" :xl="10">
            <el-form-item label="分类选择" prop="goods_type_id">
              <el-select   v-model="addRuleForm.goods_type_id"  :disabled="dailogTitle=='查看产品'" size="mini" clearable  placeholder="请选择类别"   @change="getSpecList"  >
        ...
        <el-form-item label="规格类型" v-if="dailogTitle=='新增产品'" class="proinfoborder proidclass">
          <div v-for="(s,i) in specTypeName" :key="i">
            ...
            <el-checkbox-group   v-model="s.checkedBox"   style="padding-left:20px"   @change="handleCheckedCitiesChange"     >
              <el-checkbox
        ...
        <div v-if="dailogTitle=='查看产品'">
          <el-table :data="addRuleForm.spec_combo" border size="mini" style="margin-top: 15px;">
            <el-table-column label="型号" prop="key_value" show-overflow-tooltip></el-table-column>
        ...
        <el-form-item label="推荐素材" style="margin-top:15px;">
          <el-row v-for="(mgroup,m) in addRuleForm.material" :key="m">
            <el-col :span="23">
              <el-input size="mini" v-model="mgroup.sucai" disabled>
        ...
        <el-form-item label="产品卖点">
          <el-input type="textarea" placeholder="请输入内容" v-model="addRuleForm.keywords"  maxlength="300" :autosize="{ minRows: 2, maxRows: 4}" show-word-limit disabled ></el-input>
        </el-form-item>
        <!-- 备注 -->
        <el-form-item label="备注">
          <el-input type="textarea" placeholder="请输入备注" v-model="addRuleForm.product_remarks" maxlength="300" :autosize="{ minRows: 2, maxRows: 4}" show-word-limit disabled></el-input>
        </el-form-item>
        <!-- 取消 -->
...
export default {
  ...
  methods: {
    ...
    create_Teable() {
      ...
      if (ZZARR.length > 1) {
        this.mySKUTable = this.arrp(ZZARR);
